...
import { ShieldAlert, Mail, Lock, ArrowRight, Loader2, Key, Eye, EyeOff } from 'lucide-react';
      ...
      <div className="max-w-md w-full relative z-10">
        ...
        >
          ...
          <h1 className="text-3xl font-black text-white tracking-tight mb-2">
            Admin <span className="text-blue-500">Sign In</span>
          </h1>
